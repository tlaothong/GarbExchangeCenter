  ...
  <ion-content>
    ...
    <div class="bg-white">
      <div class="mx-auto max-w-2xl py-4 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900">ใส่ข้อมูลข้อเสนอซื้อ</h2>

        <div class="mt-6 grid grid-cols-1 gap-y-0 gap-x-6 sm:grid-cols-1 lg:grid-cols-2 xl:gap-x-8">
          ...
          <!-- Product info -->
          <div
            class="mx-auto px-4 pt-4 pb-16 sm:px-4 lg:gap-x-8 lg:px-8 lg:pt-0 lg:pb-24">
            ...
            <div class="mt-4 lg:mt-0">
              ...
              <form class="mt-2" novalidate @submit.prevent="goCart">
                ...
                <ion-list>
                  <ion-item>
                    ...
                    <ion-select placeholder="ระบุสินค้า">
                      <ion-select-option>กระป๋อง</ion-select-option>
                      <ion-select-option>เหล็กเส้นยุ่ง ๆ</ion-select-option>
                      <ion-select-option>เหล็กย่อยไม่ซอย</ion-select-option>
                    </ion-select>
                  </ion-item>
                  <ion-item>
                    <ion-label position="floating">
                      ราคาเสนอซื้อ (บาท/หน่วย)
                    </ion-label>
                    <ion-input placeholder="4"></ion-input>
                  </ion-item>
                  <ion-item>
                    <ion-label position="floating">
                      จำนวน (กก.)
...
import { IonSelect, IonSelectOption, useIonRouter } from '@ionic/vue';
